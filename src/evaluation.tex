...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% QUERY ANSWERING: Query Difficulty %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
For the Refinement stage all threads, repeatedly call DeleteMin
...
%\subsection{Performance breakdown for index construction phase.}
...
\end{equation}
\begin{center}
    \text{Equation 6.1: DFreSh Latency calculation.}
\end{center} 
% 
...
If the delay is insufficient, unanswered queries from the current batch remain
...
\end{equation}
\begin{center}
    \text{Equation 6.2: FreSh Latency calculation.}
\end{center} 
